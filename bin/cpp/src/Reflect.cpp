...
HX_LOCAL_STACK_FRAME(_hx_pos_9aebbc9592e96af5_35_field,"Reflect","field",0x54b04da9,"Reflect.field","E:\\New folder (9)\\haxe\\std/cpp/_std/Reflect.hx",35,0xae4a112d)
...
bool Reflect_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Reflect_obj::field( ::Dynamic o,::String field){
            	HX_STACKFRAME(&_hx_pos_9aebbc9592e96af5_35_field)
