...
HX_DEFINE_STACK_FRAME(_hx_pos_66360ea565864631_34_new,"sys.net._Socket.SocketInput","new",0x5fe92abb,"sys.net._Socket.SocketInput.new","E:\\New folder (9)\\haxe\\std/cpp/_std/sys/net/Socket.hx",34,0xcd52e4ab)
HX_LOCAL_STACK_FRAME(_hx_pos_66360ea565864631_38_readByte,"sys.net._Socket.SocketInput","readByte",0xee593543,"sys.net._Socket.SocketInput.readByte","E:\\New folder (9)\\haxe\\std/cpp/_std/sys/net/Socket.hx",38,0xcd52e4ab)
HX_LOCAL_STACK_FRAME(_hx_pos_66360ea565864631_50_readBytes,"sys.net._Socket.SocketInput","readBytes",0x9fb565d0,"sys.net._Socket.SocketInput.readBytes","E:\\New folder (9)\\haxe\\std/cpp/_std/sys/net/Socket.hx",50,0xcd52e4ab)
HX_LOCAL_STACK_FRAME(_hx_pos_66360ea565864631_67_close,"sys.net._Socket.SocketInput","close",0xbbc7fed3,"sys.net._Socket.SocketInput.close","E:\\New folder (9)\\haxe\\std/cpp/_std/sys/net/Socket.hx",67,0xcd52e4ab)
namespace sys{
namespace net{
namespace _Socket{

void SocketInput_obj::__construct( ::Dynamic s){
            	HX_STACKFRAME(&_hx_pos_66360ea565864631_34_new)
...
int SocketInput_obj::readByte(){
            	HX_GC_STACKFRAME(&_hx_pos_66360ea565864631_38_readByte)
HXDLIN(  38)		try {
...
int SocketInput_obj::readBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_66360ea565864631_50_readBytes)
HXLINE(  51)		int r;
...
void SocketInput_obj::close(){
            	HX_STACKFRAME(&_hx_pos_66360ea565864631_67_close)
