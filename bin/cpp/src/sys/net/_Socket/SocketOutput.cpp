...
HX_DEFINE_STACK_FRAME(_hx_pos_131cf1606605fb21_78_new,"sys.net._Socket.SocketOutput","new",0x717472d4,"sys.net._Socket.SocketOutput.new","E:\\New folder (9)\\haxe\\std/cpp/_std/sys/net/Socket.hx",78,0xcd52e4ab)
HX_LOCAL_STACK_FRAME(_hx_pos_131cf1606605fb21_81_writeByte,"sys.net._Socket.SocketOutput","writeByte",0xbfd704fb,"sys.net._Socket.SocketOutput.writeByte","E:\\New folder (9)\\haxe\\std/cpp/_std/sys/net/Socket.hx",81,0xcd52e4ab)
HX_LOCAL_STACK_FRAME(_hx_pos_131cf1606605fb21_107_close,"sys.net._Socket.SocketOutput","close",0xbcc83f2c,"sys.net._Socket.SocketOutput.close","E:\\New folder (9)\\haxe\\std/cpp/_std/sys/net/Socket.hx",107,0xcd52e4ab)
namespace sys{
namespace net{
namespace _Socket{

void SocketOutput_obj::__construct( ::Dynamic s){
            	HX_STACKFRAME(&_hx_pos_131cf1606605fb21_78_new)
...
void SocketOutput_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_131cf1606605fb21_81_writeByte)
...
void SocketOutput_obj::close(){
            	HX_STACKFRAME(&_hx_pos_131cf1606605fb21_107_close)
