...
HX_DEFINE_STACK_FRAME(_hx_pos_7e183be17c0392b5_29_new,"sys.net.UdpSocket","new",0x7361a534,"sys.net.UdpSocket.new","E:\\New folder (9)\\haxe\\std/cpp/_std/sys/net/UdpSocket.hx",29,0x0eccd5aa)
HX_LOCAL_STACK_FRAME(_hx_pos_7e183be17c0392b5_30_init,"sys.net.UdpSocket","init",0x7ec79fbc,"sys.net.UdpSocket.init","E:\\New folder (9)\\haxe\\std/cpp/_std/sys/net/UdpSocket.hx",30,0x0eccd5aa)
HX_LOCAL_STACK_FRAME(_hx_pos_7e183be17c0392b5_36_sendTo,"sys.net.UdpSocket","sendTo",0x4bf4a08f,"sys.net.UdpSocket.sendTo","E:\\New folder (9)\\haxe\\std/cpp/_std/sys/net/UdpSocket.hx",36,0x0eccd5aa)
HX_LOCAL_STACK_FRAME(_hx_pos_7e183be17c0392b5_46_readFrom,"sys.net.UdpSocket","readFrom",0x35b4aa8c,"sys.net.UdpSocket.readFrom","E:\\New folder (9)\\haxe\\std/cpp/_std/sys/net/UdpSocket.hx",46,0x0eccd5aa)
namespace sys{
namespace net{

void UdpSocket_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_7e183be17c0392b5_29_new)
...
void UdpSocket_obj::init(){
            	HX_STACKFRAME(&_hx_pos_7e183be17c0392b5_30_init)
...
int UdpSocket_obj::sendTo( ::haxe::io::Bytes buf,int pos,int len, ::sys::net::Address addr){
            	HX_STACKFRAME(&_hx_pos_7e183be17c0392b5_36_sendTo)
HXDLIN(  36)		try {
...
int UdpSocket_obj::readFrom( ::haxe::io::Bytes buf,int pos,int len, ::sys::net::Address addr){
            	HX_GC_STACKFRAME(&_hx_pos_7e183be17c0392b5_46_readFrom)
HXLINE(  47)		int r;
HXLINE(  48)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
