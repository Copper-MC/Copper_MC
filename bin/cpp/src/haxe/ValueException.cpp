...
HX_DEFINE_STACK_FRAME(_hx_pos_720e4ee2dd60d8e5_23_new,"haxe.ValueException","new",0xb19045f8,"haxe.ValueException.new","E:\\New folder (9)\\haxe\\std/haxe/ValueException.hx",23,0x7b6064aa)
namespace haxe{

void ValueException_obj::__construct( ::Dynamic value, ::haxe::Exception previous, ::Dynamic native){
            	HX_STACKFRAME(&_hx_pos_720e4ee2dd60d8e5_23_new)
