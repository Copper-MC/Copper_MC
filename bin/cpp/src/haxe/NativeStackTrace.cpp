...
HX_LOCAL_STACK_FRAME(_hx_pos_2036c53e4b126e7c_12_saveStack,"haxe.NativeStackTrace","saveStack",0x471b27d9,"haxe.NativeStackTrace.saveStack","E:\\New folder (9)\\haxe\\std/cpp/_std/haxe/NativeStackTrace.hx",12,0x72dc604d)
namespace haxe{
...
void NativeStackTrace_obj::saveStack( ::Dynamic exception){
            	HX_STACKFRAME(&_hx_pos_2036c53e4b126e7c_12_saveStack)
            	}
