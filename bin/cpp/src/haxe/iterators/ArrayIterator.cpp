...
HX_DEFINE_STACK_FRAME(_hx_pos_02b3543692ece73a_28_new,"haxe.iterators.ArrayIterator","new",0x70a754c8,"haxe.iterators.ArrayIterator.new","E:\\New folder (9)\\haxe\\std/haxe/iterators/ArrayIterator.hx",28,0x40145337)
HX_LOCAL_STACK_FRAME(_hx_pos_02b3543692ece73a_45_hasNext,"haxe.iterators.ArrayIterator","hasNext",0x74587dd5,"haxe.iterators.ArrayIterator.hasNext","E:\\New folder (9)\\haxe\\std/haxe/iterators/ArrayIterator.hx",45,0x40145337)
HX_LOCAL_STACK_FRAME(_hx_pos_02b3543692ece73a_53_next,"haxe.iterators.ArrayIterator","next",0x21c2db8b,"haxe.iterators.ArrayIterator.next","E:\\New folder (9)\\haxe\\std/haxe/iterators/ArrayIterator.hx",53,0x40145337)
namespace haxe{
namespace iterators{

void ArrayIterator_obj::__construct(::cpp::VirtualArray array){
            	HX_STACKFRAME(&_hx_pos_02b3543692ece73a_28_new)
...
bool ArrayIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_02b3543692ece73a_45_hasNext)
...
HX_DEFINE_DYNAMIC_FUNC0(ArrayIterator_obj,hasNext,return )
 ...
 ::Dynamic ArrayIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_02b3543692ece73a_53_next)
