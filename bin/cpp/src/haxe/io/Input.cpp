...
HX_LOCAL_STACK_FRAME(_hx_pos_3118bd7cf914098b_51_readByte,"haxe.io.Input","readByte",0x4de8a3c2,"haxe.io.Input.readByte","E:\\New folder (9)\\haxe\\std/haxe/io/Input.hx",51,0x32bc5607)
HX_LOCAL_STACK_FRAME(_hx_pos_3118bd7cf914098b_64_readBytes,"haxe.io.Input","readBytes",0xdda6a671,"haxe.io.Input.readBytes","E:\\New folder (9)\\haxe\\std/haxe/io/Input.hx",64,0x32bc5607)
HX_LOCAL_STACK_FRAME(_hx_pos_3118bd7cf914098b_92_close,"haxe.io.Input","close",0xfc421af4,"haxe.io.Input.close","E:\\New folder (9)\\haxe\\std/haxe/io/Input.hx",92,0x32bc5607)
HX_LOCAL_STACK_FRAME(_hx_pos_3118bd7cf914098b_94_set_bigEndian,"haxe.io.Input","set_bigEndian",0x96732a9a,"haxe.io.Input.set_bigEndian","E:\\New folder (9)\\haxe\\std/haxe/io/Input.hx",94,0x32bc5607)
HX_LOCAL_STACK_FRAME(_hx_pos_3118bd7cf914098b_145_read,"haxe.io.Input","read",0x27b9839a,"haxe.io.Input.read","E:\\New folder (9)\\haxe\\std/haxe/io/Input.hx",145,0x32bc5607)
HX_LOCAL_STACK_FRAME(_hx_pos_3118bd7cf914098b_281_readInt32,"haxe.io.Input","readInt32",0xde2f3154,"haxe.io.Input.readInt32","E:\\New folder (9)\\haxe\\std/haxe/io/Input.hx",281,0x32bc5607)
namespace haxe{
namespace io{
...
int Input_obj::readByte(){
            	HX_GC_STACKFRAME(&_hx_pos_3118bd7cf914098b_51_readByte)
...
int Input_obj::readBytes( ::haxe::io::Bytes s,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_3118bd7cf914098b_64_readBytes)
HXLINE(  65)		int k = len;
...
void Input_obj::close(){
            	HX_STACKFRAME(&_hx_pos_3118bd7cf914098b_92_close)
            	}
...
bool Input_obj::set_bigEndian(bool b){
            	HX_STACKFRAME(&_hx_pos_3118bd7cf914098b_94_set_bigEndian)
...
HX_DEFINE_DYNAMIC_FUNC1(Input_obj,set_bigEndian,return )
 ...
 ::haxe::io::Bytes Input_obj::read(int nbytes){
            	HX_STACKFRAME(&_hx_pos_3118bd7cf914098b_145_read)
...
int Input_obj::readInt32(){
            	HX_STACKFRAME(&_hx_pos_3118bd7cf914098b_281_readInt32)
