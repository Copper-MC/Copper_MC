...
HX_DEFINE_STACK_FRAME(_hx_pos_edb70d4d8d46bd67_40_new,"haxe.io.BytesOutput","new",0x130b775e,"haxe.io.BytesOutput.new","E:\\New folder (9)\\haxe\\std/haxe/io/BytesOutput.hx",40,0x0b0e81c5)
HX_LOCAL_STACK_FRAME(_hx_pos_edb70d4d8d46bd67_55_writeByte,"haxe.io.BytesOutput","writeByte",0xed1b0d05,"haxe.io.BytesOutput.writeByte","E:\\New folder (9)\\haxe\\std/haxe/io/BytesOutput.hx",55,0x0b0e81c5)
HX_LOCAL_STACK_FRAME(_hx_pos_edb70d4d8d46bd67_59_writeBytes,"haxe.io.BytesOutput","writeBytes",0x8a9057ce,"haxe.io.BytesOutput.writeBytes","E:\\New folder (9)\\haxe\\std/haxe/io/BytesOutput.hx",59,0x0b0e81c5)
HX_LOCAL_STACK_FRAME(_hx_pos_edb70d4d8d46bd67_143_getBytes,"haxe.io.BytesOutput","getBytes",0x9fe35837,"haxe.io.BytesOutput.getBytes","E:\\New folder (9)\\haxe\\std/haxe/io/BytesOutput.hx",143,0x0b0e81c5)
namespace haxe{
namespace io{

void BytesOutput_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_edb70d4d8d46bd67_40_new)
...
void BytesOutput_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_edb70d4d8d46bd67_55_writeByte)
HXDLIN(  55)		this->b->b->push(c);
            	}


int BytesOutput_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_edb70d4d8d46bd67_59_writeBytes)
HXLINE(  65)		{
...
HX_DEFINE_DYNAMIC_FUNC3(BytesOutput_obj,writeBytes,return )
 ...
 ::haxe::io::Bytes BytesOutput_obj::getBytes(){
            	HX_STACKFRAME(&_hx_pos_edb70d4d8d46bd67_143_getBytes)
