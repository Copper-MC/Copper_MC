...
HX_DEFINE_STACK_FRAME(_hx_pos_1e92d4588e7ffda8_52_new,"haxe.io.BytesBuffer","new",0x022790dd,"haxe.io.BytesBuffer.new","E:\\New folder (9)\\haxe\\std/haxe/io/BytesBuffer.hx",52,0xd7525d26)
HX_LOCAL_STACK_FRAME(_hx_pos_1e92d4588e7ffda8_202_getBytes,"haxe.io.BytesBuffer","getBytes",0x1e9f7258,"haxe.io.BytesBuffer.getBytes","E:\\New folder (9)\\haxe\\std/haxe/io/BytesBuffer.hx",202,0xd7525d26)
namespace haxe{
namespace io{

void BytesBuffer_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_1e92d4588e7ffda8_52_new)
...
bool BytesBuffer_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes BytesBuffer_obj::getBytes(){
            	HX_GC_STACKFRAME(&_hx_pos_1e92d4588e7ffda8_202_getBytes)
